...
create index if not exists idx_email_messages_thread on public.email_messages using btree (thread_id) tablespace pg_default;
create unique index if not exists idx_email_messages_gmail on public.email_messages using btree (thread_id, gmail_message_id) tablespace pg_default;
create index if not exists idx_email_messages_gmail_thread on public.email_messages using btree (gmail_thread_id) tablespace pg_default;
